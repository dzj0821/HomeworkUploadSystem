...
public class UploadDao extends Dao {
	...
	public Upload[] getUploads(int homeworkId) throws ClassNotFoundException, SQLException {
		Connection connection = getConnection();
		PreparedStatement statement = connection.prepareStatement("SELECT * FROM upload WHERE homework_id = ?");
